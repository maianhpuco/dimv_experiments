...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
require(knitr)
purl("imputation_v3.Rmd", output = 'imputation_v3.R')
...
imputeAndPredictionOnEachFold <- function(fold, missing_data, data, labels, folds, dataset_name, folder_name, DIMVthreshold){ 
  ...
  write.csv(missing.X_test_normed, path.missing.X_train_mean)
...
## ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
root = "../../data/randomly_missing_dataset/svmRadial_20230114"
curr_dir = getwd()
...
#DATASETS = c("breast_tissue", "parkinsons", "new_thyroid", "breast_cancer_wisconsin")
#DATASETS = c("iris")
NUM_FOLDS = 10

DIMV_THRESHOLD_LIST = c(.01)
...
# dateset_name = 'ionosphere'
# dataset = get(dateset_name)
# label_col = get(paste0(dataset_name, "_conf"))$label_col
# label_col
# DIMVthreshold = 0.01 
# root = "../../data/randomly_missing_dataset/svmRadial_20230114"  
# 
...
# missing_rate = '0.4' 
# number_of_folds = 10 
# imputeAndClassificationPipeline(
#     dataset, 
#     dataset_name, 
#     label_col, 
#     DIMVthreshold, 
...
#     number_of_folds)
# 
# as.numeric(as.factor(ionosphere$V1))
# data = ionosphere
