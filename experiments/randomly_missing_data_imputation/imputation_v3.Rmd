...
ecoli = read.table('https://archive.ics.uci.edu/ml/machine-learning-databases/ecoli/ecoli.data', header = FALSE, sep = "", dec = ".")
...
# matrix(data)
# 
# createRandomlyMissingData(as.numeric(data), 0.3)
# ```
...
# 
# 
#   result = imputeAndPredictionOnEachFold(1, missing_data, data, labels, folds, dataset_name, folder_name, DIMVthreshold) 
# ```
# ```{r}
